    ...
    stages {
        ...
        stage ('Test') {
            ...
            steps {
                ...
                publishHTML([allowMissing: false, alwaysLinkToLastBuild: false, keepAll: false, reportDir: '/var/lib/jenkins/workspace/django_line/htmlcov', reportFiles: 'myapp_admin_py.html', reportName: 'HTML Report', reportTitles: ''])
                }
            }
    }
}
